...
public class AddDonorDetails extends JFrame implements ActionListener {
    JLabel header;
    JPanel panel1;
    JPanel panel2;
    JPanel p1;
    ...
    AddDonorDetails() {
        ...
        try {
            ...
            String query = "SELECT MAX(donorId) FROM BloodBankDetails";
    ...
    public void actionPerformed(ActionEvent a) {
        if (a.getSource() == submit) {
            ...
            System.out.println("INSERT INTO BloodBankDetails(donorId,fullName,phoneNum,gender,city,bloodGrp)VALUES("
                    + donId + ",'" + fn + "'," + p + ",'" + g + "','" + c + "','" + b + "');");
            try {
                Class.forName("com.mysql.cj.jdbc.Driver");
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/DIU_Blood_Bank", "dipto",
                ...
                PreparedStatement ps = con.prepareStatement(
                        "INSERT INTO BloodBankDetails(donorId,fullName,phoneNum,gender,city,bloodGrp)VALUES("
                                + donId + ",'" + fn + "'," + p + ",'" + g + "','" + c + "','" + b + "');");
                ps.executeUpdate();
                con.close();
                ps.close();
